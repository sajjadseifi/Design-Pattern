...
namespace Design_Pattern.Prototype
{
    public class Prototype : IRun
    {
        public void Run()
        {
            ...
            var file_1_1 = new File("file_1_1", "f");
            var file_1_2 = new File("file_1_2", "f");
            var file_1_3 = new File("file_1_3", "f");
            ...
            var file_2_1 = new File("file_2_1", "f");
            var file_2_2 = new File("file_2_2", "f");
